...
<head>
  ...
  <style>
    ...
    .intro {
      ...
      width: 100%;
      height: 520px;
      background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://thumbs.dreamstime.com/b/silhouettes-happy-women-sunset-young-middle-aged-adult-concept-diversity-195855118.jpg");
...
<body>
  ...
  <main>
    <div class="intro">
      <h1>HAPPINESS INDEX TEST</h1>
      <p> Lest's cheack your hapiness index. YEY! </p>
      <a href="test.php"><button>Take Test</button></a>
    </div>
